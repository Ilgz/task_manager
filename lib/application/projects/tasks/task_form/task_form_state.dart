...
abstract class TaskFormState with _$TaskFormState{
  factory TaskFormState({required Task task,AutovalidateMode? showErrorMessages,required bool isProcessing,required Option<Either<ProjectFailure,Unit>> projectFailureSuccessOption,required bool isEditing})= _TaskFormState;
