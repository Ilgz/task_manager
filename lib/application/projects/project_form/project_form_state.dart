...
abstract class ProjectFormState with _$ProjectFormState{
  factory ProjectFormState({required Project project,AutovalidateMode? showErrorMessages,required bool isProcessing,required Option<Either<ProjectFailure,Unit>> projectFailureSuccessOption,required bool isEditing})= _ProjectInFormState;
