...
import 'package:task_manager/application/auth/auth_bloc.dart' as _i15;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i9.ProjectActorBloc>(
        () => _i9.ProjectActorBloc(gh<_i7.IProjectRepository>()));
    gh.factory<_i10.ProjectFilterBloc>(() => _i10.ProjectFilterBloc());
    gh.factory<_i11.ProjectFormBloc>(
        () => _i11.ProjectFormBloc(gh<_i7.IProjectRepository>()));
    gh.factory<_i12.ProjectWatcherBloc>(
        () => _i12.ProjectWatcherBloc(gh<_i7.IProjectRepository>()));
    gh.factory<_i13.SignInFormBloc>(
        () => _i13.SignInFormBloc(gh<_i5.IAuthFacade>()));
    gh.factory<_i14.TaskFormBloc>(
        () => _i14.TaskFormBloc(gh<_i7.IProjectRepository>()));
